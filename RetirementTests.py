...
@given('User is using the application and a month is given as input')
...
@given('User is using the application and a year is given as input')
...
@given('Birth month has been given and is a valid input')
...
@given('Birth year has been given and is a valid input')
...
@when('Information has been successfully given to the program and verified')
...
# ----------------------------------------------------------------------
@then('Information is compiled and formatted for results')
